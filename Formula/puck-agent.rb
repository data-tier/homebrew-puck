class PuckAgent < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/data-tier/puck-agent/releases/download/v#{version}/puck-agent-darwin-arm64"
      sha256 "b78f0f59af385daf0d7a3da92cc2becb566f390cf15962c652886294fd1b4059"
    end
    on_intel do
      url "https://github.com/data-tier/puck-agent/releases/download/v#{version}/puck-agent-darwin-amd64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/data-tier/puck-agent/releases/download/v#{version}/puck-agent-linux-arm64"
      sha256 "1fb25bd25316ce3fc7714fdb156e7c8fb24bee6527073949f700114965aefcc7"
    end
    on_intel do
      url "https://github.com/data-tier/puck-agent/releases/download/v#{version}/puck-agent-linux-amd64"
